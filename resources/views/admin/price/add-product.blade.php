                    ...
                    <div class="col-xs-8">
                        <div class="box box-primary">
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <label for="excerpt" class="col-sm-12 control-label lft-align">Price</label>
                                    <div class="col-sm-12">
                                        <input type="text" class="form-control" name="excerpt" id="excerpt" placeholder="Price" value="<?php echo (!empty($post->excerpt))? $post->excerpt : ''; ?>">
