<?php
$author_post="";$enteredby="";$keywords="";$metadesc="";$editor_choice = ""; $featured_news ="";
if(!empty($post))
{
  ...
  foreach($postmeta as $pm)
  {
    ...
    if($pm->meta_key=='metadesc')
      ...
      if($pm->meta_key=='editor_choice')
         echo $editor_choice = $pm->meta_value;
      if($pm->meta_key=='featured_news')
         echo $featured_news = $pm->meta_value;
  }
}
?>
	...
	<section class="content-header">
      ...
      <div class="col-xs-4">
        ...
        <div class="box box-primary">
          ...
          <div class="box box-primary">
              <div class="box-header with-border">
                  <h3 class="box-title">Editor's Choice</h3>
              </div>
              <div class="box-body">

                  <div class="radio">
                      <label>
                          <input type="radio" name="editor_choice" id="editor_choice_yes" value="yes"
                          <?php echo(isset($editor_choice)&&(($editor_choice)=="yes"))?"checked":""; ?>
                           >
                          Yes
                      </label>
                  </div>
                  <div class="radio">
                      <label>
                          <input type="radio" name="editor_choice" id="editor_choice_no" value="no"
                          <?php echo(isset($editor_choice)&&(($editor_choice)=="no"))?"checked":""; ?>>
                          No
                      </label>
                  </div>
          ...
          <div class="box box-primary">
              <div class="box-header with-border">
                  <h3 class="box-title">Featured News</h3>
              </div>
              <div class="box-body">

                  <div class="radio">
                      <label>
                          <input type="radio" name="featured_news" id="featured_news_yes" value="yes"
                          <?php echo(isset($featured_news)&&(($featured_news)=="yes"))?"checked":""; ?>
                                  >
                          Yes
                      </label>
                  </div>
                  <div class="radio">
                      <label>
                          <input type="radio" name="featured_news" id="featured_news_no" value="no"
                          <?php echo(isset($featured_news)&&(($featured_news)=="no"))?"checked":""; ?>>
                          No
                      </label>
                  </div>
        ...
        <div class="box box-primary">
            ...
            <div class="box-body">
                ...
                @if(!empty($post->image))
                    <img src="{{ URL::to($post->image) }}" id="holder" style="margin-top:15px;max-height:100px;">
                @endif
